...
import { l as GROUP_EXPAND_BTN, h as GROUP_EXPAND_EVENT, m as PSEUDO_GROUP_ITEM, G as GROUP_EXPANDED, c as GROUP_DEPTH, C as ColumnService, i as isGrouping } from './columnService.js';
import { d as ROW_FOCUSED_CLASS } from './consts.js';
import { g as getSourceItem } from './data.store.js';
import { a as RowRenderer, d as defineCustomElement$1 } from './revogr-cell2.js';
...
const RevogrData = /*@__PURE__*/ proxyCustomElement(class RevogrData extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement() {
  ...
  const components = ["revogr-data", "revogr-cell"];
