...
export type DimensionDataViewport = Pick<RevoGrid.DimensionSettingsState, 'indexes' | 'positionIndexes' | 'positionIndexToItem' | 'sizes' | 'originItemSize' | 'realSize'>;
...
export declare function recombineByOffset(offset: number, data: RecombineOffsetData): ItemsToUpdate | null;
/**
