...
const FilterPanel = class {
  ...
  renderExtra(prop, index$1) {
    ...
    if (this.filterEntities[currentFilter[index$1].type].extra !== 'input')
      return '';
    return (index.h("input", { id: `filter-input-${currentFilter[index$1].id}`,
      // placeholder="Enter value..."
      type: "text", value: currentFilter[index$1].value, onInput: this.onUserInput.bind(this, index$1, prop), onKeyDown: e => this.onKeyDown(e) }));
  }
  getFilterItemsList() {
    var _a;
    ...
    return (index.h("div", { key: this.filterId }, propFilters.map((d, index$1) => {
      ...
      if (index$1 !== this.filterItems[prop].length - 1) {
        (index.h("div", { onClick: () => this.toggleFilterAndOr(d.id) }, index.h(filter_button.AndOrButton, { isAnd: d.relation === 'and' })));
      }
      return (index.h("div", { key: d.id, class: FILTER_LIST_CLASS }, index.h("div", { class: { 'select-input': true } }, index.h("select", { class: "select-css select-filter", onChange: e => this.onFilterTypeChange(e, prop, index$1) }, this.renderSelectOptions(this.filterItems[prop][index$1].type, false)), index.h("div", { onClick: () => this.onReset() }, index.h(filter_button.TrashButton, null))), index.h("div", null, this.renderExtra(prop, index$1))));
    })));
  }
  render() {
    if (!this.changes) {
    ...
    return (index.h(index.Host, { style: style }, index.h("label", null, capts.title), index.h("div", { class: "filter-holder" }, this.getFilterItemsList()), index.h("div", { class: "filter-actions" }, this.disableDynamicFiltering &&
      index.h(RevoButton, { class: { red: true, save: true }, onClick: () => this.onSave() }, capts.save))));
  }
