...
import { i as isArrayLike_1, _ as _baseIteratee, k as keys_1, f as findIndex_1, a as _baseEach, b as isArray_1, c as _arrayMap, r as reduce_1, g as getSourceItem, d as getSourceItemVirtualIndexByProp, e as each, s as setSourceByVirtualIndex, D as DataStore, h as getVisibleSourceItem, j as createStore, l as setStore, m as calculateDimensionData, R as RESIZE_INTERVAL, n as getItemByIndex, o as gatherTrimmedItems, p as _baseProperty, q as _getTag, t as _baseKeys, u as toInteger_1, v as _isIterateeCall, w as timeout, x as getPhysical, y as setItems, U as UUID, z as getScrollbarWidth, A as getItemByPosition } from './index-a937c03b.js';
import { l as lodash, i as isGrouping, g as getGroupingName, G as GROUP_EXPANDED, a as getParsedGroup, b as isSameGroup, c as GROUP_DEPTH, P as PSEUDO_GROUP_ITEM_VALUE, d as PSEUDO_GROUP_ITEM_ID, e as GROUPING_ROW_TYPE, f as PSEUDO_GROUP_COLUMN, h as GROUP_EXPAND_EVENT, j as gatherGrouping, k as isGroupingColumn, E as EMPTY_INDEX, m as getLastCell, H as HEADER_SLOT, C as CONTENT_SLOT, F as FOOTER_SLOT, D as DATA_SLOT, S as SelectionStoreConnector } from './viewport.helpers-b34b34b0.js';
import { V as ViewportStore, c as calculateRowHeaderSize, g as getFromEvent } from './events-a9d2c5b9.js';
import { F as FILTER_PROP, i as isFilterBtn } from './filter.button-143a6a60.js';
import { i as isObjectLike_1, _ as _baseGetTag, d as debounce_1 } from './debounce-48584128.js';
...
class DimensionProvider {
  constructor(viewports, config) {
    ...
    const sizeChanged = lodash.debounce((k) => config.realSizeChanged(k), RESIZE_INTERVAL);
  ...
  return [
    h("div", { class: "main-viewport", ref: e => (el = e), onClick: e => viewPortClick(e, el) },
      h("div", { class: "viewports" },
        children,
        h("revogr-scroll-virtual", { class: "vertical", dimension: typeRow, viewportStore: viewports[typeRow].store, dimensionStore: dimensions[typeRow].store, ref: el => registerElement(el, 'rowScroll'), onScrollVirtual: e => onScroll(e.detail) }),
    ...
    view.dataPorts.forEach((data, j) => {
      ...
      const dataView = (h("revogr-overlay-selection", Object.assign({}, data, { isMobileDevice: isMobile, selectionStore: data.segmentSelectionStore, onSelectall: () => onSelectAll(), editors: editors, readonly: readonly, range: range, useClipboard: useClipboard, onCancelEdit: () => onCancelEdit(), applyChangesOnClose: applyEditorChangesOnClose, onSetEdit: ({ detail }) => onEdit(detail), additionalData: additionalData, slot: data.slot }),
        h("revogr-data", Object.assign({}, data, { [UUID]: data.uuid }, { key: key, readonly: readonly, range: range, rowClass: rowClass, rowSelectionStore: data.rowSelectionStore, additionalData: additionalData, slot: DATA_SLOT }),
          h("slot", { name: `data-${view.type}-${data.type}` })),
        ...
        h("revogr-focus", { colData: data.colData, dataStore: data.dataStore, focusTemplate: focusTemplate, rowType: data.type, colType: view.type, selectionStore: data.segmentSelectionStore, dimensionRow: data.dimensionRow, dimensionCol: data.dimensionCol },
          h("slot", { name: `focus-${view.type}-${data.type}` }))));
