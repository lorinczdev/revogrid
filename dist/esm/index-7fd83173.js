    ...
    if (!hmrVersionId || !BUILD.hotModuleReplacement) {
      ...
      switch(bundleId) {
        ...
        case 'revogr-focus_5':
          return import(
            /* webpackMode: "lazy" */
            './revogr-focus_5.entry.js').then(processMod, consoleError);
        case 'revogr-cell_4':
          return import(
            /* webpackMode: "lazy" */
            './revogr-cell_4.entry.js').then(processMod, consoleError);
        case 'revogr-edit_2':
          return import(
            /* webpackMode: "lazy" */
            './revogr-edit_2.entry.js').then(processMod, consoleError);
      }
    }
    return import(
    /* @vite-ignore */
